...
public class CSolicitudTutoria extends CGeneral {
	...
	private String[] mensaje = {
			"Su Tutoria ha sido aprobada, le enviamos su usuario y contrase�a",
	...
	public void aceptarTutoria() throws IOException{
		...
		for (int i = 0; i < ltbSolicitudesEstudiantes.getItemCount(); i++){
			...
			valor.add(enviarEmailNotificacion(estudiante.getCorreoElectronico(), mensaje[0]+" Usuario: "+user.getNombre()+"  "+"Contrase�a: "+user.getNombre()));
		}
	...
	public void rechazarTutoria(){
		Messagebox.show("¿Desea rechazar tutoria?",
				"Dialogo de confirmacion", Messagebox.OK
						| Messagebox.CANCEL, Messagebox.QUESTION,
				new org.zkoss.zk.ui.event.EventListener() {
					public void onEvent(Event evt)
