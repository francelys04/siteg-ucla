...
public class SCronograma {
	...
	public List<Cronograma> buscarCronogramaPorLapsoYPrograma(
			Programa programa, Lapso lapso) {
		List<Cronograma> cronogramas;
		cronogramas = interfaceCronograma
				.findByProgramaAndLapsoOrderByFechaInicioAsc(programa, lapso);
		return cronogramas;
	}

	public Cronograma buscarCronogramaPorLapsoProgramaYActividad(
			Programa programa, Lapso lapso, Actividad actividad) {
		Cronograma cronogramaActividad;
		cronogramaActividad = interfaceCronograma
				.findByProgramaAndLapsoAndActividad(programa, lapso, actividad);
